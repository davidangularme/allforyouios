...
@class SRMotorcyclesViewController;
...
@interface LIExposeController : UIViewController <UIGestureRecognizerDelegate, UIScrollViewDelegate,NSFetchedResultsControllerDelegate>{
@private
...
@property (strong, nonatomic) SRMotorcyclesViewController *tabledviewController;
@property (nonatomic,assign) UIView *containerViewtemp;
@property (nonatomic,assign) UILabel *labeltemp;
